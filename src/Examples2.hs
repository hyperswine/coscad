...
bookend =
  let
    -- Overall dimensions
    totalHeight = 15.0  -- 15cm tall
    totalWidth = 8.0    -- 8cm wide
    thickness = 2.0     -- 2cm thick
    ...
    slabProfile =
      let
        -- Points for the slab profile (viewed from the side)
...
detailedBookend :: Shape
detailedBookend = bookendDetailed

roundedBookend :: Shape
